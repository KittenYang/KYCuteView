...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   Gooey effects bubble with gamecenter effects
                   DESC

  s.homepage     = "https://github.com/KittenYang/KYCuteView"
  ...
  s.source       = { :git => "https://github.com/KittenYang/KYCuteView.git", :tag => s.version.to_s }
